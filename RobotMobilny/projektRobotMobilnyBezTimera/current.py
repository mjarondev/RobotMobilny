...
class StartGUI(QtWidgets.QMainWindow):
    ...
    def manualSend(self):
        ...
        if self.model.isConnected() and self.ui.radioManual.isChecked():
    ...
    def connectClicked(self):
        ...
        if not self.model.isConnected():
            ...
            self.thread.signals.result.connect(self.exchangeResult)
    ...
    def exchangeResult(self, s):
        self.model.setFrameReceived(s[1:-1])
        self.updateOnExchange()
